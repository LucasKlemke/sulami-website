    ...
    >
      ...
      <div className="absolute inset-0 bg-primary">
        <Image
          ...
          sizes="100vw"
        />
        {/* Substitua o src acima por: /images/hero-bg.jpg (1920x800 recomendado) */}
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6">
        <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-accent-light sm:text-base">
          Desde 1997
        </p>
        <h1 className="mb-6 text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
          Mil Mármores
          <br />
          <span className="text-accent-light">e Granitos</span>
        </h1>
        <p className="mx-auto mb-10 max-w-2xl text-lg text-white/80 sm:text-xl">
          Tradição e qualidade há mais de 28 anos. Excelência em mármores,
          granitos, quartzos e quartzitos para transformar seus ambientes.
        </p>
